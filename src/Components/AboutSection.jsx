...
const AboutSection = () => {
  return (
    <div className='w-[100%] h-[120vh] mx-4 grid md:grid-cols-[30%_70%] grid-cols-1 border-[1px] border-gray-300 border-t-0'>
      ...
      <div className='relative w-[100%] h-auto border-[1px] border-gray-300 border-t-0'>
        <div className=' absolute flex items-start justify-end w-[96%] h-[116vh] my-10 mr-4'>
          <img className='absolute z-10 w-[65%] h-[110vh] bg-cover' src={mainImg} />
        </div>
        <img className=' absolute mx-4 my-4 w-[96%] h-[116vh] bg-cover' src={bgImg} />
      </div>
    </div>
  )
}
